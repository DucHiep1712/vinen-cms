    ...
    <div className="min-h-screen bg-background p-8">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-3xl font-bold">Quản lý thẻ tin tức</h1>
        </div>
          ...
          <div className="mb-6">
            ...
            <div className="flex gap-2 mt-2">
              <Input
                ...
                className="flex-1"
              />
              <Button onClick={addTag} size="icon" className="cursor-pointer">
              ...
              <div className="flex flex-wrap gap-2">
                {tags.map((tag) => (
                  ...
                  >
                    ...
                    >
                      <X className="w-3 h-3 hover:text-red-500 hover:cursor-pointer" />
                    </button>
                  </div>
                ))}
              </div>
